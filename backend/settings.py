...
SECRET_KEY = 'django-insecure-r9kdqg=g$i(&j(wmwndmazj13%b60mlx&o$r*(@&f40=mtfkaz'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = [
    "backend-03ah.onrender.com",
    "127.0.0.1"
]
...
# CORS configuratie
CORS_ORIGIN_ALLOW_ALL = True  # Voor development alleen
# Of specifieke origins toestaan:
